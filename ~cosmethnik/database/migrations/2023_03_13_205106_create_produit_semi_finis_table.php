...
class CreateProduitSemiFinisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('produit_semi_finis', function (Blueprint $table) {
            $table->increments('id');
            $table->string('nom');
            ...
            $table->string('poids_nette_egoutte')->nullable();
            $table->string('freinte_produit')->nullable();
            $table->string('taille_portion')->nullable();
            ...
            $table->dateTime('pao')->nullable();
            $table->dateTime('duree_vie_minimum')->nullable();
            $table->integer('condition_conservation_id')->unsigned()->nullable();
            $table->integer('precaution_emploie_id')->unsigned()->nullable();
            $table->string('conseil_preparation_utilisation')->nullable();
            $table->double('prix_vente_uv')->nullable();
            $table->integer('monnaie_id')->unsigned()->nullable();
            $table->integer('quantite_imprevisionnelle')->nullable();
    ...
    {
        Schema::drop('produit_semi_finis');
    }
}
