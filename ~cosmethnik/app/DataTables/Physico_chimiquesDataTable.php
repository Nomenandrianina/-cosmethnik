...
class Physico_chimiquesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return $dataTable->addColumn('action', 'physico_chimiques.datatables_actions');
    }

    /**
     * Get query source of dataTable.
     *
     * @param \App\Models\Physico_chimiques $model
    ...
    {
        return 'physico_chimiques_datatable_' . time();
    }
}
