...
class FamilleDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            'parent_id' => new Column(['title' => __('models/familles.fields.parent__id'), 'data' => 'parent_id']),
            'model_type' => new Column(['title' => __('models/familles.fields.model_type'), 'data' => 'model_type']),
            'model_id' => new Column(['title' => __('models/familles.fields.model_id'), 'data' => 'model_id'])
        ];
    }
