        ...
        <div class="card-body login-card-body">
            ...
            <form method="post" action="{{ url('/login') }}">
                ...
                <div class="input-group mb-3">
                    <input type="email" name="email" value="usertest@gmail.com" placeholder="@lang('auth.login.field.email')"  class="form-control @error('email') is-invalid @enderror">
                ...
                <div class="input-group mb-3">
                    <input type="password" name="password" placeholder="@lang('auth.login.field.password')" value="Usertest" class="form-control @error('password') is-invalid @enderror">
                    <div class="input-group-append">
