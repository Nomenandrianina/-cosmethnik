<div class="modal fade" id="ressource-modal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-elements">
        ...
        <div class="modal-content">
            ...
            <div class="modal-header modal-head-color">
                <h4 class="modal-title fs-5" id="exampleModalLabel">Créer un nouveau ressource</h4>
            </div>
            ...
            <div class="modal-footer">
                ...
                {!! Form::submit('Enregistrer', ['class' => 'btn btn-primary','onclick'=>'Store_ressources();']) !!}
                <button id="ressource_close" class="btn btn-default">
                    @lang('crud.cancel')
                </button>
